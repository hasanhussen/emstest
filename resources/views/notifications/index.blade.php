        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="modal-title text-text-bold-600" id="title">اضافة اشعار   </label>
                ...
                <form action="#" method="post" id="editFromData">
                    ...
                    <div class="modal-body">
                       <div class="row">
                        ...
                        <div class="col-md-6"> <label>  الوصف  </label>
                            <div class="form-group">
                                <input type="text" name="text" id="text" placeholder="" class="form-control">
                                <div id="img-list">
    ...
    <script type="text/javascript">
        ...
        $("#addClick").click(function (e) {
            ...
            $('body').on('click', '.edit', function () {
                ...
                $("#title").html("تعديل ");
                $.get("{{ route('notifications.index') }}" + '/' + product_id + '/edit', function (data) {
                    $("#saveBtn").val("حفظ");
                    $('#_id').val(data.id);
            ...
            $("#saveBtn").click(function (e) {
                ...
                var card_id = $("#_id").val();
                var method="post";
                var url = "{{ route('notifications.store') }}";
                if(card_id){
                   url = "{{ route('notifications.index') }}"+ '/' + card_id 
                   method="PATCH";}
                $.ajax({
            ...
            $('body').on('click', '.delete', function () {
                ...
                if (confirmed) {
                    $.ajax({
            type: "DELETE",
            url: "{{ route('notifications.index') }}"+ '/' + product_id,
            data:{
                '_token':'{{csrf_token()}}'
            },
            success: function (data) {
