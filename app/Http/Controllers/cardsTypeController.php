...
{ 
    ...
    if ($validateErrors->fails()) {
        ...
        $id =  CardsType::updateOrCreate(['id' => $request->_id],
            $data)->id;
    ...
    {
        return  $this->editController($id,CardsType::class);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        CardsType::updateOrCreate(['id' => $request->_id],
        $data);
...
return response()->json(['status'=>200,'message' => ' تم حفظ البيانات بنجاح    .' ]);
    ...
    {
        $this->destroyController($id,CardsType::class);
    }
}
