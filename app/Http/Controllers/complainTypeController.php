...
{    use allTrait;
    ...
    return view('complains.complain_type');
    }
    ...
    public function store(Request $request)
    {
        ...
        $id =  ComplainType::updateOrCreate(['id' => $request->_id],
            $data)->id;
    ...
    {
        return  $this->editController($id,ComplainType::class);
    ...
    public function update(Request $request, $id)
    {
        ...
        ComplainType::updateOrCreate(['id' => $request->_id],
        $data);
...
return response()->json(['status'=>200,'message' => ' تم حفظ البيانات بنجاح    .' ]);
    ...
    {
        $this->destroyController($id,ComplainType::class);
    }
}
