...
class catalogeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $id =  Cataloge::updateOrCreate(['id' => $request->_id],
            $data)->id;
    ...
    { 
        return  $this->editController($id,Cataloge::class);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Cataloge::updateOrCreate(['id' => $request->_id],
        $data);
...
return response()->json(['status'=>200,'message' => ' تم حفظ البيانات بنجاح    .' ]);
    ...
    {
        $this->destroyController($id,Cataloge::class);
    }
}
