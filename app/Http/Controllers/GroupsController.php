...
{   use allTrait;
    ...
    {
    $this->middleware('permission:المجموعات', ['only' => ['index','store']]);
    $this->middleware('permission:اضافة مجموعة', ['only' => ['create','store']]);
    $this->middleware('permission:تعديل مجموعة', ['only' => ['edit','update']]);
    $this->middleware('permission:حذف مجموعة', ['only' => ['destroy']]);
    }
    ...
    {
        return  $this->editController($id, Group::class);
    }
